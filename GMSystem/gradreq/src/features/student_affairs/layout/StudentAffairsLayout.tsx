...
import { StudentAffairsProvider } from '../contexts/StudentAffairsContext';
...
const StudentAffairsLayout = () => {
  ...
  // Notifications hook
  const { notifications, loading: notificationsLoading, markAsRead, unreadCount } = useNotifications();
