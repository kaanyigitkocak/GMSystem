...
interface SecretaryRegistrationFormProps {
  onSubmit: (formData: SecretaryFormData) => void;
}
...
const SecretaryRegistrationForm = ({ onSubmit }: SecretaryRegistrationFormProps) => {
...
export default SecretaryRegistrationForm; 