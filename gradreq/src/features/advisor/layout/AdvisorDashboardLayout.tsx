...
const AdvisorDashboardLayout = ({ children }: AdvisorDashboardLayoutProps) => {
  ...
  const navItems = [
    { path: '/advisor', icon: <DashboardIcon />, label: 'Dashboard', exact: true },
    { path: '/advisor/students', icon: <PersonIcon />, label: 'My Students' },
    { path: '/advisor/petitions', icon: <DescriptionIcon />, label: 'Petition Management' },
    { path: '/advisor/manual-check', icon: <AssignmentTurnedInIcon />, label: 'Manual Check Requests' }
  ];
            ...
            <Box sx={{ display: 'flex' }}>
              ...
              >
                <MenuItem sx={{ py: 1, px: 2 }}>
                  <Typography variant="body2">New manual check request from Ahmet Yılmaz</Typography>
                </MenuItem>
                <Divider />
                <MenuItem sx={{ py: 1, px: 2 }}>
                  <Typography variant="body2">Graduation approval deadline is approaching</Typography>
                </MenuItem>
                <Divider />
                <MenuItem sx={{ py: 1, px: 2 }}>
                  <Typography variant="body2">Transcript updated for Zeynep Öztürk</Typography>
                </MenuItem>
                <Divider />
                <MenuItem 
                  sx={{ 
